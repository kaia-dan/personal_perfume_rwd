<!-- 스타트영역include --><? include_once $_SERVER["DOCUMENT_ROOT"]."/personal_perfume_rwd/inc/start.html" ?>
...
<body>
<!-- 헤더영역include --><? include_once $_SERVER["DOCUMENT_ROOT"]."/personal_perfume_rwd/inc/header.html" ?>
  <!-- 비쥬얼영역시작 -->
  <section id="visual_wrap">
  <div id="visual_inner">
    <h2 class="hidden">향기메인비쥬얼</h2>
    <ul id="visual_list">
      <li><img src="/personal_perfume_rwd/images/visual_00.png" alt="향기사이트비쥬얼"></li>
      <li><img src="/personal_perfume_rwd/images/visual_01.png" alt="향기사이트비쥬얼"></li>
      <li><img src="/personal_perfume_rwd/images/visual_02.png" alt="향기사이트비쥬얼"></li>
      <li><img src="/personal_perfume_rwd/images/visual_03.png" alt="향기사이트비쥬얼"></li>
      <li><img src="/personal_perfume_rwd/images/visual_04.png" alt="향기사이트비쥬얼"></li>
    </ul>
      <!-- 비쥬얼네비게이터시작 -->
      <!-- <ul id="slide_gather">
        <li>첫번째슬라이드</li>
      ...
      <ul id="contents_service_list">
        <li>
          <p class="contents_img">
            <img src="/personal_perfume_rwd/images/contents_img_00.png" alt="향기브랜드란?">
          </p>
        ...
        <li>
          <p class="contents_img">
            <img src="/personal_perfume_rwd/images/contents_img_01.png" alt="예민한피부에안전하다">
          </p>
          <p class="contents_text_big">
        ...
        <li>
          <p class="contents_img">
            <img src="/personal_perfume_rwd/images/contents_img_02.png" alt="향수와예술활동">
          </p>
          <p class="contents_text_big">
        ...
        <li>
          <p class="contents_img">
            <img src="/personal_perfume_rwd/images/contents_img_03.png" alt="건강한아로마테라피효과">
          </p>
          <p class="contents_text_big">
        ...
        <li>
          <p class="contents_img">
            <img src="/personal_perfume_rwd/images/contents_img_04.png" alt="향기구독서비스">
          </p>
          <p class="contents_text_big">
            SCENT SUBSCRIPTION
          </p>
        ...
        <li>
          <p class="contents_img">
            <img src="/personal_perfume_rwd/images/contents_img_05.png" alt="환경을위한기부">
          </p>
          <p class="contents_text_big">
  ...
  <div class="movie_wrap">
    <div id="movie_inner">
      ...
      <p id="perfume_icon">
        <img src="/personal_perfume_rwd/images/icon.png" alt="향수병">
      </p>
  ...
  <!-- 컨텐츠영역끝 -->
  <!-- 푸터영역include --><? include_once $_SERVER["DOCUMENT_ROOT"]."/personal_perfume_rwd/inc/footer.html" ?>
</body>
</html>